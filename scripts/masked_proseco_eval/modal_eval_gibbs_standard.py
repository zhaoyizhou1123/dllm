...
Uses Gibbs-standard bidirectional block diffusion (GibbsSampler with edit_strategy=gibbs_standard).
...
Run:
    modal run scripts/masked_proseco_eval/modal_eval_gibbs_standard.py
...
app = modal.App("dllm-llada-eval-gibbs-standard")
...
def evaluate(
    ...
    if not output_dir:
        output_dir = (
            ...
            f"gibbs_standard_bidir_block{block_size}_steps{steps}"
