"""
Run Mask-ProSeCo SFT training for LLaDA-8B on Modal with 8x H100 GPUs.
...
Train:
    modal run scripts/modal_sft_mask_proseco.py

Resume from checkpoint:
    modal run scripts/modal_sft_mask_proseco.py --resume /checkpoints/mask_proseco_rstar/step_1000

Disable flash attention:
    modal run scripts/modal_sft_mask_proseco.py --no-flash-attention
"""
...
app = modal.App("dllm-llada-mask-proseco")
...
NGPUS = 8
# Global batch = NGPUS x bs 4 x grad_accum = 8 x 4 x 16 = 512
GRAD_ACCUM = 512 // (NGPUS * 4)
...
def train(
    ...
    output_dir: str = "/checkpoints/mask_proseco_rstar",
